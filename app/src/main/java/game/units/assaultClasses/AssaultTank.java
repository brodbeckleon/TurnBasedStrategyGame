...
public abstract class AssaultTank extends AssaultClass implements Army, ByRoad {
    ...
    public AssaultTank(int playerID, String name, Point position, int resourceCost, int healthPoints, int armorValue, int shootingRange, int drivingRange, int damage) {
